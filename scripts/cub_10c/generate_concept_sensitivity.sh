...
ARTIFACT=$1
RECALIBRATED_MODELS_BASE="/mnt/sdc/cub_sensitivity/cub_10c_models/sensitivity/sensitivity_config_cub_10c_forehead/recalib/"
#force update sensitivity result location
SENSITIVITY_RESULTS_LOCATION="/mnt/sdc/cub_sensitivity/cub_10c_models/sensitivity/sensitivity_config_cub_10c_${ARTIFACT}"
