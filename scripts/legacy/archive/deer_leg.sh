...
SENSITIVITY_RESULTS_LOCATION="/mnt/sdb2/sensitivity_analysis_paper/run2/sensitivity_config_s_deer_leg"
...
#2
CONFIG_FILE="../../config/legacy/config_s_deer_leg.yaml"
...
for model in "${MODELS_ARRAY[@]}"; do
    ...
    mv /home/srikanth/study1/RecalibrateNN/scripts/legacy/cav /home/srikanth/study1/RecalibrateNN/scripts/legacy/cav_${model}_deer_leg
done
