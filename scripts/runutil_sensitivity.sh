...
python ${PYTHON_SCRIPT}  --before_after  --org_model_path "/home/srikanth/trained_models/pytorch/vgg16/vgg16.pth"  --model_name "vgg16" --recal_model_basepath /mnt/sdd/basics/ --store_results   /mnt/sdd/basics/ --config ${CONFIG}
